...
Currently, SillyAI is practically fully implemented (minus advanced reasoning through SillyISA, but that's fine). It just needs real-world testing and validation. It could use additional/better plugin support but that's not the priority right now.
