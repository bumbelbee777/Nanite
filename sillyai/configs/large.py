...
class LargeModelConfig(ModelConfig):
    ...
    # Modality support
    supported_modalities: Set[Modality] = field(default_factory=lambda: {Modality.TEXT, Modality.IMAGE, Modality.AUDIO})
    
    # Plugin configuration
    enabled_plugins: list = field(default_factory=lambda: ['trainer', 'visualizer', 'profiler']) 